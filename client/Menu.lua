...
function Arta.MainMenu()
    ...
    Arta.Menus.MainMenu:ControlDisablingEnabled(true)
    Arta.Menus.MainMenu:BuildingAnimation(MenuBuildingAnimation.LEFT_RIGHT)
    Arta.Menus.MainMenu:AnimationType(MenuAnimationType.CUBIC_INOUT)
	Arta.Menus.MainMenu:ScrollingType(MenuScrollingType.CLASSIC)
	Arta.Menus.MainMenu:CounterColor(Colours.HUD_COLOUR_YELLOW)
    ...
    if Arta.Player.IsDriving then 
        ...
        --------- Pimp My Ride -- Arta.Menus.MainMenu Customs 
            ...
            if LiveryCount ~= 0 then 
                ...
                LiveryItem.OnListSelected = function (menu, item, index)
                    SetVehicleMod(Arta.Player.Vehicle,48,LiveryValues[index])
                    local message = "Livery applied >> " .. index
                    ScaleformUI.Notifications:ShowNotification(message)
                end
            else
                local LiveryItem = UIMenuListItem.New("No Livery", LiveryCount, "Livery","Own it!")
            ...
            CosmeticsMenu:ControlDisablingEnabled(true)
            CosmeticsMenu:BuildingAnimation(MenuBuildingAnimation.RIGHT)
            CosmeticsMenu:AnimationType(MenuAnimationType.CUBIC_INOUT)
            CosmeticsMenu:ScrollingType(MenuScrollingType.CLASSIC)
            CosmeticsMenu:CounterColor(Colours.HUD_COLOUR_YELLOW)

            
            -----------------------------------------------
            if Arta.Player.IsDriving then
                for _, mod in ipairs(ArtaConf.LSTables.vehicleMods) do
                    --print("Name: " .. mod.name)
                    --print("ID: " .. mod.id)
            ...
            ----------------------------------------------
            CosmeticsMMItem.Activated = function(menu, item)
                menu:SwitchTo(CosmeticsMenu, 1, true)
            end
            -------------------------
        ...
        MyCarMainItem.Activated = function(menu, item)
...
--
    ...
    Arta.Menus.MainMenu:AddItem(ketchupItem)
    ...
    local scrollingAnimationItem = UIMenuListItem.New("Choose the scrolling animation", animations, Arta.Menus.MainMenu:AnimationType(),
    ...
    Arta.Menus.MainMenu:AddItem(scrollingAnimationItem)

	local scrollItem = UIMenuListItem.New("Choose how this menu will ~o~scroll~s~!", { "CLASSIC", "PAGINATED", "ENDLESS" }, Arta.Menus.MainMenu:ScrollingType())
    Arta.Menus.MainMenu:AddItem(scrollItem)
    ...
    Arta.Menus.MainMenu:AddItem(cookItem)
	...
	Arta.Menus.MainMenu.OnItemSelect = function(menu, item, index)
    ...
    Arta.Menus.MainMenu:AddItem(dynamicListItem)
    ...
    Arta.Menus.MainMenu:AddItem(seperatorItem1)
    Arta.Menus.MainMenu:AddItem(seperatorItem2)
    ...
    Arta.Menus.MainMenu:AddItem(listPanelItem1)
    ...
    Arta.Menus.MainMenu:AddItem(listPanelItem2)
    ...
    Arta.Menus.MainMenu:AddItem(listPanelItem3)
    ...
    Arta.Menus.MainMenu:AddItem(listPanelItem4)
    ...
    Arta.Menus.MainMenu:AddItem(windowItem)
    ...
    Arta.Menus.MainMenu.OnMenuOpen = function(menu)
		print("Menu opened!")
    end
    Arta.Menus.MainMenu.OnMenuClose = function(menu)
        print("Menu closed!")
    end
    ...
    Arta.Menus.MainMenu:Visible(true)
	Arta.Menus.MainMenu:Title("Scaleform~HUD_COLOUR_PURPLE~UI")
	Arta.Menus.MainMenu:Subtitle("~p~Colored ~HUD_COLOUR_ORANGE~Subtitle")
end
