...
function CreateRaceMenu()
    ...
    local MyCarMenu = UIMenu.New("Personal Vehicle", VehInfo.Name, 50, 50, true, nil, nil, true)
    --------- Pimp My Ride -- RaceMenu Customs 
        ...
        --- Customs Menu 
        local RMCustomsMenu = UIMenu.New("RaceMenu Customs", VehInfo.Name, 50, 50, true, nil, nil, true)
        -- Customs Menu code
            --
            RMCustomsStandalone()
            --
        -------------------------
        --- Customs Menu register
        -------------------------
         -- register it , store it , buy it , pump it , polka dot it 
        -------------------------
        MyCarCustomsItem.Activated = function(menu, item) -- adds funtion to item and the function is scaleforms switchto 
            menu:SwitchTo(RMCustomsMenu, 1, true)
        end
				...
				if raceScores ~= nil then
						...
						for k, score in pairs(drawScores) do
                            ...
                            if score.time then
                                ...
                                if RMplayer == TTTKing then TrackScoreItem:LeftBadge(BadgeStyle.Crown) end -- player is the top leaderboard , future SpeedMaster/ Drift King - badge should be changed according to ScaleUI 
                            else
...
function RMCustomsStandalone()
    ...
    local CustomsMainMenu = UIMenu.New("BMZ Customs", "Powered by Awesome ScaleformUI", 50, 50, true, "scaleformui", "menuBanner", true)
    ...
    PaintshopMMItem.Activated(menu)
end
