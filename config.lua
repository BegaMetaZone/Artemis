...
ArtaConf.LSTables.paintsChameleon = {
    ...
    {name = "Blue Anodized", id = 164},
    {name = "Green Anodized", id = 165},
    {name = "Lime Anodized", id = 166},
    {name = "Copper Anodized", id = 167},
    {name = "Bronze Anodized", id = 168},
    {name = "Champagne Anodized", id = 169},
    {name = "Gold Anodized", id = 170},
